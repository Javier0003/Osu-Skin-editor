...
export default function ModalComp({ path, asset, name, close }: Modal) {
  ...
  return (
    <div className="absolute h-1/2 w-1/2 bg-zinc-800 flex flex-col place-items-center rounded-lg justify-between p-14">
